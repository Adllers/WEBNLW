            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    ...
                    <div className="field">
                        ...
                        <input name='name' type="text" id="name" onChange={handleInputChange}/>       
                    </div>
                </fieldset>
                ...
                <div id="field-group">
                    <div className="field">
                        ...
                        <input name='email' type="email" id="email" onChange={handleInputChange}/>       
                    </div>
                </div>
                ...
                <div id="field-group">
                    <div className="field">
                        ...
                        <input name='whatsapp' type="text" id="whatsapp" onChange={handleInputChange}/>       
                    </div>
                </div>
